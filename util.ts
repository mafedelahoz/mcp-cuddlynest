// Generic helpers, carried over from the MCP scaffolding this repo was seeded with.
// Nothing here is CuddlyNest- or Airbnb-specific: these are small object/JSON
// utilities used by the static-HTML parsing path.
